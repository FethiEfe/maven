...
class Modal extends Component {
    ...
    handleClick = e => {
        ...
        if (minutes) {
            ...
            axios.all([
                axios.get(`https://${process.env.REACT_APP_API_USERNAME}:${process.env.REACT_APP_API_PASSWORD}@opensky-network.org/api/flights/departure?airport=${this.props.airportICAO}&begin=${xMinsAgo}&end=${currentTime}`),
                axios.get(`https://${process.env.REACT_APP_API_USERNAME}:${process.env.REACT_APP_API_PASSWORD}@opensky-network.org/api/flights/arrival?airport=${this.props.airportICAO}&begin=${xMinsAgo}&end=${currentTime}`)
            ])
        ...
        return (
            <div >
                <Dialog open={this.props.open}
                    ...
                    <h1 style = {{textAlign: "center", marginTop: "5px"}}>{this.props.cityName}</h1>
                    <div id="input-div">
